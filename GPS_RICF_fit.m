function [beta, omega, hatCovMat, ricf] = GPS_RICF_fit(smm, covMat, tol)
% version adapted from RICF_fit.m from GSMAG

% first added step: convert MAG encoding to expected smm encoding?
% not yet: now done in calling routine
